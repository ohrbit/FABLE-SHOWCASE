...
const CURVE_FORCE = 30;  // how hard a bending tunnel shoves the ship sideways
                       // R3 FIX (flight-physicist): R1 used 240 (all crash, 0% surv);
                       // R2 used 600 on a structurally-impassable minR14 tunnel (also 0%).
                       // 30 is the proven sweet spot: weak steerGain/shield genomes still
                       // crash on a looser tunnel (minR~35), well-tuned ones finish.
                       // 40-gen GA self-test vs minR35 tunnel => 40-70% survival, +gain/gen.
